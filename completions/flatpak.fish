...
complete -c flatpak -n "__fish_seen_subcommand_from info" -s o -l show-origin -d "Show the remote ref installed from."l
...
complete -c flatpak -xn "__fish_seen_subcommand_from run" -l own-name -d "Allow the app to own the name in the session bus"
complete -c flatpak -xn "__fish_seen_subcommand_from run" -l talk-name -d "Allow the app to talk the name in the session bus"
complete -c flatpak -xn "__fish_seen_subcommand_from run" -l system-own-name -d "Allow the app to own the name in the system bus"
complete -c flatpak -xn "__fish_seen_subcommand_from run" -l system-talk-name -d "Allow the app to talk the name in the system bus"
